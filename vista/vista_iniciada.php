            ...
            <div class="col-md-4 col-sm-12">
                <div class="sidebar-menu">
                    ...
                    <div class="logo-wrapper">
                        <a rel="nofollow" href="index.php"><img src="../images/logo 2.0.png" alt="Circle Template" style="width:100%">
                        <h1 class="logo">
                    ...
                    <div class="menu-wrapper">
                        <ul class="menu">
                            <li><a class="show-1" href="#">Inicio</a></li>
                            ...
                            <li><a rel="nofollow" href="http://www.google.com">Arma Tu Bicicleta</a></li>
                        </ul> <!-- /.menu -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12">
                                <div class="toggle-content text-center" id="tab1">
                                    ...
                                    <div id="salir"  method="post" name="login" >
                                     
                                        <input type="submit" id="btnlogin" value="Cerrar sesion" onclick="salir()">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-4">
                                <div class="member-item">
                                    ...
                                    <div class="modal fade " id="mimodal4" tabindex="0" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                                             <div class="modal-dialog">
                                                <div class="modal-content">
                                                  <div class="modal-header">                                         
                    ...
                    <div id="menu-4" class="gallery content">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-ms-6">
                                <div class="g-item">
                                    <img src="../images/productos/g1.jpg" alt="">
                                    <a data-rel="lightbox" class="overlay" href="../images/productos/g1.jpg">
                                        <span>+</span>
                                    </a>
                                </div> <!-- /.g-item -->
                            </div> <!-- /.col-md-4 -->
                            ...
                            <div class="col-md-4 col-ms-6">
                                <div class="g-item">
                                    <img src="../images/productos/g2.jpg" alt="">
                                    <a data-rel="lightbox" class="overlay" href="../images/productos/g2.jpg">
                                        <span>+</span>
                                    </a>
                                </div> <!-- /.g-item -->
                            </div> <!-- /.col-md-4 -->
                            ...
                            <div class="col-md-4 col-ms-6">
                                <div class="g-item">
                                    <img src="../images/productos/g3.jpg" alt="">
                                    <a data-rel="lightbox" class="overlay" href="../images/productos/g3.jpg">
                                        <span>+</span>
                                    </a>
                                </div> <!-- /.g-item -->
                            </div> <!-- /.col-md-4 -->
                            ...
                            <div class="col-md-4 col-ms-6">
                                <div class="g-item">
                                    <img src="../images/productos/g4.jpg" alt="">
                                    <a data-rel="lightbox" class="overlay" href="../images/productos/g4.jpg">
                                        <span>+</span>
                                    </a>
                                </div> <!-- /.g-item -->
                            </div> <!-- /.col-md-4 -->
                            ...
                            <div class="col-md-4 col-ms-6">
                                <div class="g-item">
                                    <img src="../images/productos/g5.jpg" alt="">
                                    <a data-rel="lightbox" class="overlay" href="../images/productos/g5.jpg">
                                        <span>+</span>
                                    </a>
                                </div> <!-- /.g-item -->
                            </div> <!-- /.col-md-4 -->
                            ...
                            <div class="col-md-4 col-ms-6">
                                <div class="g-item">
                                    <img src="../images/productos/g6.jpg" alt="">
                                    <a data-rel="lightbox" class="overlay" href="../images/productos/g6.jpg">
                                        <span>+</span>
                                    </a>
                                </div> <!-- /.g-item -->
                            </div> <!-- /.col-md-4 -->
                            ...
                            <div class="col-md-4 col-ms-6">
                                <div class="g-item">
                                    <img src="../images/productos/g7.jpg" alt="">
                                    <a data-rel="lightbox" class="overlay" href="../images/productos/g7.jpg">
                                        <span>+</span>
                                    </a>
                                </div> <!-- /.g-item -->
                            </div> <!-- /.col-md-4 -->
                            ...
                            <div class="col-md-4 col-ms-6">
                                <div class="g-item">
                                    <img src="../images/productos/g8.jpg" alt="">
                                    <a data-rel="lightbox" class="overlay" href="../images/productos/g8.jpg">
                                        <span>+</span>
                                    </a>
                                </div> <!-- /.g-item -->
                            </div> <!-- /.col-md-4 -->
                            ...
                            <div class="col-md-4 col-ms-6">
                                <div class="g-item">
                                    <img src="../images/productos/g9.jpg" alt="">
                                    <a data-rel="lightbox" class="overlay" href="../images/productos/g9.jpg">
                                        <span>+</span>
                                    </a>
                                </div> <!-- /.g-item -->
                            </div> <!-- /.col-md-4 -->
