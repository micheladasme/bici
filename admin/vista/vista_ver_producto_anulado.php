...
<div class="well" style="height:auto;">
    ...
    <table class="table">
        ...
        {
            $res2 = muestraProductosAnuladosNom($_GET['txt_consulta']);
            foreach ($res2 as $f) {
                echo(
                    "<tr class='post'>
            ...
            <td> <a href='../control/controlActivarProducto.php?codigo=".$f['pro_cod']."'
                                               class='btn btn-sm btn-success'><span
                            class='glyphicon glyphicon-plus-sign'></span> Activar </a> </td>"
        ...
        foreach ($res as $f) {
            ...
            <tr class="post">
                ...
                <th style="font-weight:100"><a href="../control/controlActivarProducto.php?codigo=<?php echo $f["pro_cod"]; ?>"
                                               class="btn btn-sm btn-success"><span
                            class='glyphicon glyphicon-plus-sign'></span> Activar </a></th>
            </tr>
