...
if($page!=$last){
  $next = $page + 1;
  $paginador2 = '<a href="vista_ver_promocion.php?page='.$next.'">Siguente -></a>';
  $paginadorL = '<a href="vista_ver_promocion.php?page='.$last.'">Ultimo >></a>';
}
if($page!=1){
  $prev = $page - 1;
  $paginador = '<a href="vista_ver_promocion.php?page='.$prev.'"><- Anterior</a>';
  $paginadorP = '<a href="vista_ver_promocion.php?page=1"><< Primero</a>';
}
