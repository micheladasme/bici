...
$start=(($page-1)*$reg);
$res = muestraStockBodega($start,$reg);

if($last!=1){

if($page!=$last){
  $next = $page + 1;
  $paginador2 = '<a href="vista_stock_bodega.php?page='.$next.'">Siguente -></a>';
  $paginadorL = '<a href="vista_stock_bodega.php?page='.$last.'">Ultimo >></a>';
}
if($page!=1){
  $prev = $page - 1;
  $paginador = '<a href="vista_stock_bodega.php?page='.$prev.'"><- Anterior</a>';
  $paginadorP = '<a href="vista_stock_bodega.php?page=1"><< Primero</a>';
}
...
<html lang="en">
  ...
  <?php include($_SESSION['header']);  ?>
          <div class="well" style="height:auto;">
           <h3 class="text-center">Stock Bodega</h3><hr>
...
?>
          <tr>
              ...
              <th><a href="../../control/superadmin/controlEStock.php?codigo=<?php echo $f['pu_id']; ?>" class="btn btn-sm btn-danger" role="button"><span class="glyphicon glyphicon-trash"></span>&nbsp Eliminar</a>  </th>
          </tr>
<?php
    }
?>
