                    ...
                    <div style="padding-top:30px" class="panel-body" >
                        ...
                        <form id="loginform" action="control/control_login.php" method="post" class="form-horizontal" role="form">
                            ...
                            <div style="margin-bottom: 25px" class="input-group">
                                        ...
                                        <input  id="txt_usu" name="txt_usu" type="text" class="form-control"  placeholder="Usuario">                                        
                                    </div>
                            ...
                            <div style="margin-bottom: 25px" class="input-group">
                                ...
                                <div style="margin-top:10px" class="form-group">
                                    ...
                                    <div class="col-sm-12 controls">
                                      <input type="submit" id="btn-login" value="Entrar" href="#" class="btn btn-warning btn-block" onclick="valida()">
